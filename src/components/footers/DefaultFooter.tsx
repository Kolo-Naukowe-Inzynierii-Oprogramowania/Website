...
const navigation = {
    social: [
        {
            name: 'Facebook',
            href: 'https://www.facebook.com/profile.php?id=61552480628944',
            icon: (props: PropsOf<Icon>) => (
        ...
        {
            name: 'GitHub',
            href: 'https://github.com/Kolo-Naukowe-Inzynierii-Oprogramowania',
            icon: (props: PropsOf<Icon>) => (
                <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
                    <path
                        fillRule="evenodd"
        ...
        {
            name: 'YouTube',
            href: 'https://www.youtube.com/@knio-pb',
            icon: (props: PropsOf<Icon>) => (
                <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
                    <path
                        fillRule="evenodd"
        ...
        <footer>
            ...
            <div className="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8">
                ...
                <p className="mt-1 text-center text-xs leading-5 text-gray-500">
                    ...
                    Nie jesteśmy częścią oficjalnej struktury uczelni, ale działamy pod jej patronatem, wspierając rozwój akademicki i praktyczne
                    umiejętności studentów w dziedzinie inżynierii oprogramowania.
                </p>
            </div>
        </footer>
    )
