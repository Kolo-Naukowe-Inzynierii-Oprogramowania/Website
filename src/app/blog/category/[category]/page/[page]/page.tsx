...
export default async function Page({
    ...
    try {
        ...
        const res = await axios.get(`https://strapi.assts.tech/api/blog-posts?populate=*&filters[categories][slug][$containsi]=${category}&pagination[pageSize]=5&pagination[page]=${page || 1}&sort=createdAt:desc`, {
            headers: {
                // public get token
                Authorization: "bearer ",
            },
